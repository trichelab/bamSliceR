...
getTxsAnnotation = function(res, txdb = gencode.v36.txs.coords.txdb) {
...
getTxsVsGenomic <- function(gencode.file = "", vr = NULL)
{
...
getVariantAnnotationForTxs = function(gencode.file = "", format = "gff3", query.ranges = NULL)
{
  ...
  suppressWarnings(getTxsAnnotation(query.ranges, txdb = txdb)) -> tr_txs_vr_baminfo_f_annot
  ...
  genomicVsTxs = getTxsVsGenomic(gencode.file = gencode.file, query.ranges)
...
makeTxDbFromGFF(gencode.v36.txs.coords,
                ...
                organism="Homo sapiens",
                taxonomyId=9606) -> gencode.v36.txs.coords.txdb
getTxsAnnotation(tr_txs_vr_baminfo_f, txdb = gencode.v36.txs.coords.txdb) -> tr_txs_vr_baminfo_f_annot
...
getTxsAnnotation(tr_txs_vr_baminfo_f, txdb = new.gencode.v36.txs.coords.txdb) -> new.tr_txs_vr_baminfo_f_annot
